{
  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        "arn:${data_aws_partition_current_partition}:codecommit:${data_aws_region_current_name}:${data_aws_caller_identity_current_account_id}:*account-request*",
        "arn:${data_aws_partition_current_partition}:codecommit:${data_aws_region_current_name}:${data_aws_caller_identity_current_account_id}:terraform-aws-control_tower_account_factory"
      ]
    },
    {
      "Effect": "Allow",
