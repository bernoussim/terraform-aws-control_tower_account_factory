...
module "aft_code_repositories" {
  ...
  aft_s3_bucket_name                                 = var.aft_s3_bucket_name
  account_request_s3_object_name                     = var.account_request_s3_object_name
  global_customizations_s3_object_name               = var.global_customizations_s3_object_name
  account_customizations_s3_object_name              = var.account_customizations_s3_object_name
  account_provisioning_customizations_s3_object_name = var.account_provisioning_customizations_s3_object_name
